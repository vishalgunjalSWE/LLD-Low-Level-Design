...
public class VectorExample {
    public static void main(String[] args) {
        ...
        // Method 4: iterator() - returns an iterator to access elements of the
        // collection
        ...
        // Method 5: addAll() - adds all the elements of a specified collection to the
        // collection
        ...
        // Method 6: removeAll() - removes all the elements of the specified collection
        // from the collection
